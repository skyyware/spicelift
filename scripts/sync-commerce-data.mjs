...
const useCases = [
  {
    ...
    heading: 'Alles für Bagel, Avocado und Ei.',
    summary: 'Zwei Mischungen, die Brunch schnell rund machen: Sesam-Crunch für den Bagel, Kräuter-Zitrus-Frische für Avocado und Dip.',
